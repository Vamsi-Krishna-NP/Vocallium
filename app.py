...
if Model == "GEMINI":
    tkey = st.text_input("Geminai API key here:", "")
...
#########################################################################################################
            ...
            speak("I have been made by vamsi and vishaal.")
            st.write("I have been made by vamsi and vishaal.")
